...
REPORT_JSON = BASE_DIR / "../reports/coverage.json"
OUTPUT_HTML = BASE_DIR / "../reports/coverage_dashboard.html"
HISTORY_FILE = BASE_DIR / "../reports/coverage_history.json"
...
history_data = history_data[-30:]  # mantener últimos 30
